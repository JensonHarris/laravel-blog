...
<script type="text/html" id="navDemo">
    @{{#  if(d.is_nav ==0){ }}
    <button class="layui-btn layui-btn-xs layui-bg-cyan" lay-event="disabled">非导航</button>
    @{{#  }  else { }}
    <button class="layui-btn layui-btn-xs layui-bg-blue" lay-event="start">导航</button>
    @{{#  } }}
</script>
